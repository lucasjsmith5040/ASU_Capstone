...
## Data prep -------------------------------------------------------------------
# Load pca
pcaData <- read.table("/geneticData/variants/filtered_AF/combined/merged237/pca/10/pcaResults.eigenvec", header = FALSE, stringsAsFactors = FALSE)
...
# Load metadata
metadata <- read.csv("/geneticData/sequencingMetadata.csv")
