...
biosampleFile <- "/geneticData/biosample_result.txt"
...
srrBiosample <- read.table("/geneticData/srr_biosample.txt", header = FALSE, stringsAsFactors = FALSE)
...
write.csv(metadataFin, "/geneticData/sequencingMetadata.csv", row.names = FALSE)
