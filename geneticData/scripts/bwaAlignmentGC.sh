#!/bin/bash
#SBATCH --job-name=bwaAlignmentGC
...
OUT_DIR="/scratch/dbihnam/lsc585/turtleProject/alignedBam/GC_test"
...
#Run alignment
#Optimized to deal with high GC-content
bwa mem -t 8 -T 20 -B 3 -O 4,48 -E 3,3 -L 5,5 -M "$REF" "${FASTQ_DIR}/${SAMPLE}_1_paired.fastq.gz" "${FASTQ_DIR}/${SAMPLE}_2_paired.fastq.gz" | \
